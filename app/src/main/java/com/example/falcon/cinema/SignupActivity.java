...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user= (EditText) findViewById(R.id.edt_auth_signup_username);
        pass= (EditText) findViewById(R.id.edt_auth_signup_password);
    ...
    class CreateUser extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject jObject = makeHttpRequest(config.SIGNUP_URL,
                        params);
        ...
        protected void onPostExecute(String result) {
            ...
            pDialog.dismiss();
            if (result != null) {
                Toast.makeText(SignupActivity.this, result, Toast.LENGTH_LONG)
                        .show();
            }
        }
